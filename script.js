...
.hero{padding:80px 20px;text-align:center;background:#38bdf8;color:black}
.hero img{width:140px;height:140px;border-radius:50%;object-fit:cover}
.section{max-width:900px;margin:60px auto;padding:0 20px}
.skills{display:flex;flex-wrap:wrap;gap:12px}
.skill{background:white;color:black;padding:10px 18px;border-radius:25px;font-weight:600}
...
<div class="section"><h2>About Me</h2><p>${about}</p></div>
<div class="section"><h2>Skills</h2><div class="skills">${skills}</div></div>
<div class="section"><h2>Projects</h2><ul>${projects}</ul></div>
<div class="section">
...
.hero{text-align:center;padding:80px 20px;border-bottom:1px solid #e5e7eb}
.hero img{width:120px;height:120px;border-radius:50%;object-fit:cover;margin-bottom:12px}
.container{max-width:900px;margin:60px auto;padding:0 20px}
.skills{display:flex;flex-wrap:wrap;gap:12px}
.skill{border:1px solid #ddd;padding:10px 18px;border-radius:20px}
...
.header-content{max-width:1000px;margin:auto;display:flex;align-items:center;gap:30px}
.header img{width:120px;height:120px;border-radius:10px;object-fit:cover}
.section{max-width:1000px;margin:50px auto;background:white;padding:30px}
.skills{display:flex;flex-wrap:wrap;gap:10px}
.skill{background:#0f172a;color:white;padding:8px 14px;border-radius:4px;font-size:13px}
...
<div class="section"><h2>Professional Summary</h2><p>${about}</p></div>
<div class="section"><h2>Skills</h2><div class="skills">${skills}</div></div>
<div class="section"><h2>Projects</h2><ul>${projects}</ul></div>
<div class="section">
<a href="${github}">GitHub</a> |
